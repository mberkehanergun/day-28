        ...
        try {
            ...
            loginButton.setOnAction(event -> {
                ...
                if (loginFail == false && ifNotExit == true) {
                    ...
                    buttonLayout.getChildren().addAll(companySettingsButton, loadCustomersButton, acceptInternsButton, processWorkButton, processTempCustomersButton, fetchTasksButton, arrangeTasksButton, task1Button, task2Button, backButton);
